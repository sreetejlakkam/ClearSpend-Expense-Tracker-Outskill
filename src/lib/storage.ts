...
export function getInitialDemoState(userId: string = 'demo_user_1') {
  ...
  const recurringItems: RecurringItem[] = [
    {
      ...
      wallet_id: 'w_bank',
      is_active: true,
      last_charged_date: getDemoDateStr(0, 1),
    ...
    },
    {
      ...
      wallet_id: 'w_card',
      is_active: true,
      last_charged_date: getDemoDateStr(0, 15),
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString(),
    },
    {
      ...
      wallet_id: 'w_card',
      is_active: true,
      last_charged_date: getDemoDateStr(0, 20),
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString(),
    },
    {
      ...
      wallet_id: 'w_bank',
      is_active: true,
      last_charged_date: getDemoDateStr(0, 5),
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString(),
    },
  ];
  ...
  const goals: Goal[] = [
    ...
    },
    {
      id: 'goal_macbook',
      user_id: userId,
      title: 'M4 MacBook Pro Studio Rig',
  ...
  const demoHousehold = {
    ...
    budgets: [
      ...
      },
      {
        id: 'hb_groceries',
        household_id: 'hh_sharma_demo',
        name: 'Household Groceries & Staples',
        amount: 16000,
        period: 'monthly',
        start_month: '2026-08-01',
        created_by: userId,
    ...
    goals: [
      {
        id: 'hg_downpayment',
        household_id: 'hh_sharma_demo',
        name: '2BHK Apartment Down Payment',
      ...
      },
      {
        id: 'hg_goa',
        household_id: 'hh_sharma_demo',
        name: 'Annual Goa Villa Vacation',
