...
export const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    'budgets.title': 'Monthly Budget Envelopes',
    'budgets.subtitle': 'Envelope limits, 5-month trends, proactive burn rate & velocity infographics',
    ...
    'budgets.add_envelope': 'Set Envelope',
    'budgets.pacing_simulator': 'Interactive Pacing Simulator',
    'budgets.subtab_envelopes': 'Envelopes',
    'budgets.subtab_committed': 'Committed & Trends',
    'budgets.subtab_subscriptions': 'Subscriptions',
    'budgets.subtab_goals': 'Goals',
    'budgets.subtab_simulator': 'Simulator',
    'budgets.remaining_pool': 'Remaining Envelope Pool',
    'budgets.safe_daily_target': 'Safe Daily Target',
    'budgets.actual_burn_rate': 'Actual Burn Rate',
    'budgets.days_remaining': 'days remaining in month',
    'budgets.status_over': 'Over Budget',
    'budgets.status_caution': 'Caution Zone',
    'budgets.status_healthy': 'Healthy Pace',
    'budgets.spent': 'Spent',
    'budgets.limit': 'Limit',
    'budgets.daily_cap': 'Daily Cap',
    'budgets.projected': 'Projected',

    // Ledger & History
    'ledger.search_placeholder': 'Search merchant, category, amount, or note…',
    'ledger.all_months': 'All Months',
    'ledger.all_categories': 'All Categories',
    'ledger.all_wallets': 'All Wallets',
    'ledger.all_types': 'All Types',
    'ledger.expenses_only': 'Expenses Only',
    'ledger.income_only': 'Income Only',
    'ledger.import_csv': 'Import CSV',
    'ledger.export_csv': 'Export CSV',
    'ledger.transactions_recorded': 'transactions recorded',
    'ledger.no_txns': 'No transactions match your filters',

    // ClearScore™ Financial Health Radar (Surprise Feature)
    'clearscore.title': 'ClearScore™ Health Radar',
    'clearscore.subtitle': 'Real-time 100-point financial fitness index & 5-pillar wealth radar',
    'clearscore.grade_label': 'Financial Fitness Grade',
    'clearscore.emergency_runway': 'Emergency Runway',
    'clearscore.savings_velocity': 'Savings Rate Velocity',
    'clearscore.burn_adherence': 'Daily Burn Discipline',
    'clearscore.fixed_commitments': 'Fixed Commitments (50/30/20)',
    'clearscore.envelope_health': 'Budget Envelope Health',
    'clearscore.prescriptions_title': 'AI Financial Prescriptions',
    'clearscore.stress_test_title': 'What-If Financial Scenario Playground',
    'clearscore.score_label': 'Score',
  ...
  te: {
    ...
    // Budgets & Committed Money
    'budgets.title': 'నెలవారీ బడ్జెట్ ఎన్వలప్‌లు',
    'budgets.subtitle': 'ఎన్వలప్ పరిమితులు, 5-నెలల ధోరణులు, ముందస్తు ఖర్చు వేగం & ఇన్ఫోగ్రాఫిక్స్',
    ...
    'budgets.add_envelope': 'కేటగిరీ బడ్జెట్ సెట్ చేయండి',
    'budgets.pacing_simulator': 'ఇంటరాక్టివ్ పేసింగ్ సిమ్యులేటర్',
    'budgets.subtab_envelopes': 'బడ్జెట్‌లు',
    'budgets.subtab_committed': 'నిబద్ధత & ధోరణులు',
    'budgets.subtab_subscriptions': 'సబ్‌స్క్రిప్షన్‌లు',
    'budgets.subtab_goals': 'లక్ష్యాలు',
    'budgets.subtab_simulator': 'సిమ్యులేటర్',
    'budgets.remaining_pool': 'మిగిలిన బడ్జెట్ పూల్',
    'budgets.safe_daily_target': 'సురక్షిత రోజువారీ లక్ష్యం',
    'budgets.actual_burn_rate': 'వాస్తవ ఖర్చు రేటు',
    'budgets.days_remaining': 'నెలలో మిగిలిన రోజులు',
    'budgets.status_over': 'బడ్జెట్ మించింది',
    'budgets.status_caution': 'హెచ్చరిక జోన్',
    'budgets.status_healthy': 'ఆరోగ్యకరమైన వేగం',
    'budgets.spent': 'ఖర్చు',
    'budgets.limit': 'పరిమితి',
    'budgets.daily_cap': 'రోజువారీ పరిమితి',
    'budgets.projected': 'అంచనా',

    // Ledger & History
    'ledger.search_placeholder': 'మర్చంట్, కేటగిరీ, మొత్తం లేదా నోట్ ద్వారా వెతకండి…',
    ...
    'ledger.expenses_only': 'ఖర్చులు మాత్రమే',
    'ledger.income_only': 'ఆదాయం మాత్రమే',
    'ledger.import_csv': 'CSV దిగుమతి',
    'ledger.export_csv': 'CSV ఎగుమతి',
    'ledger.transactions_recorded': 'లావాదేవీలు నమోదు చేయబడ్డాయి',
    'ledger.no_txns': 'మీ ఫిల్టర్లకు సరిపోయే లావాదేవీలు లేవు',

    // ClearScore™ Financial Health Radar (Surprise Feature)
    'clearscore.title': 'క్లియర్ స్కోర్™ ఆరోగ్య రాడార్',
    'clearscore.subtitle': 'రియల్-టైమ్ 100-పాయింట్ల ఆర్థిక ఫిట్‌నెస్ ఇండెక్స్ & 5-స్తంభాల సంపద రాడార్',
    'clearscore.grade_label': 'ఆర్థిక ఫిట్‌నెస్ గ్రేడ్',
    'clearscore.emergency_runway': 'ఎమర్జెన్సీ రన్‌వే',
    'clearscore.savings_velocity': 'పొదుపు రేటు వేగం',
    'clearscore.burn_adherence': 'రోజువారీ ఖర్చు క్రమశిక్షణ',
    'clearscore.fixed_commitments': 'స్థిర నిబద్ధతలు (50/30/20)',
    'clearscore.envelope_health': 'బడ్జెట్ ఎన్వలప్ ఆరోగ్యం',
    'clearscore.prescriptions_title': 'ఏఐ ఆర్థిక సూచనలు',
    'clearscore.stress_test_title': 'ఆర్థిక దృశ్య అనుకరణ (స్ట్రెస్ టెస్ట్)',
    'clearscore.score_label': 'స్కోర్',
  ...
  hi: {
    ...
    // Budgets & Committed Money
    'budgets.title': 'मासिक बजट एनवेलप्स',
    'budgets.subtitle': 'एनवेलप सीमाएं, 5-महीने के ट्रेंड, दैनिक बर्न रेट और इन्फोग्राफिक्स',
    ...
    'budgets.add_envelope': 'बजट एनवेलप सेट करें',
    'budgets.pacing_simulator': 'इंटरएक्टिव पेसिंग सिमुलेटर',
    'budgets.subtab_envelopes': 'एनवेलप्स',
    'budgets.subtab_committed': 'प्रतिबद्धताएं और ट्रेंड',
    'budgets.subtab_subscriptions': 'सब्सक्रिप्शन',
    'budgets.subtab_goals': 'लक्ष्य',
    'budgets.subtab_simulator': 'सिमुलेटर',
    'budgets.remaining_pool': 'शेष एनवेलप पूल',
    'budgets.safe_daily_target': 'सुरक्षित दैनिक लक्ष्य',
    'budgets.actual_burn_rate': 'वास्तविक खर्च दर',
    'budgets.days_remaining': 'महीने में शेष दिन',
    'budgets.status_over': 'बजट से अधिक',
    'budgets.status_caution': 'सावधानी क्षेत्र',
    'budgets.status_healthy': 'स्वस्थ गति',
    'budgets.spent': 'खर्च',
    'budgets.limit': 'सीमा',
    'budgets.daily_cap': 'दैनिक सीमा',
    'budgets.projected': 'अनुमानित',

    // Ledger & History
    'ledger.search_placeholder': 'दुकानदार, श्रेणी, राशि या नोट द्वारा खोजें…',
    'ledger.all_months': 'सभी महीने',
    'ledger.all_categories': 'सभी श्रेणियां',
    'ledger.all_wallets': 'सभी खाते',
    'ledger.all_types': 'सभी प्रकार',
    'ledger.expenses_only': 'केवल खर्च',
    'ledger.income_only': 'केवल आय',
    'ledger.import_csv': 'CSV आयात करें',
    'ledger.export_csv': 'CSV निर्यात करें',
    'ledger.transactions_recorded': 'लेन-देन दर्ज किए गए',
    'ledger.no_txns': 'फ़िल्टर से मेल खाते कोई लेन-देन नहीं मिले',

    // ClearScore™ Financial Health Radar (Surprise Feature)
    'clearscore.title': 'क्लियर स्कोर™ स्वास्थ्य रडार',
    'clearscore.subtitle': 'रीयल-टाइम 100-पॉइंट वित्तीय फिटनेस इंडेक्स और 5-स्तंभ वेल्थ रडार',
    'clearscore.grade_label': 'वित्तीय फिटनेस ग्रेड',
    'clearscore.emergency_runway': 'आपातकालीन रनवे',
    'clearscore.savings_velocity': 'बचत दर गति',
    'clearscore.burn_adherence': 'दैनिक खर्च अनुशासन',
    'clearscore.fixed_commitments': 'निश्चित प्रतिबद्धताएं (50/30/20)',
    'clearscore.envelope_health': 'बजट एनवेलप स्वास्थ्य',
    'clearscore.prescriptions_title': 'एआई वित्तीय सुझाव',
    'clearscore.stress_test_title': 'वित्तीय परिदृश्य अनुकरण (स्ट्रेस टेस्ट)',
    'clearscore.score_label': 'स्कोर',
